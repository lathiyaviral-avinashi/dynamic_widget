...
class BackGroundDataParser extends WidgetParser {
  @override
  bool forWidget(String widgetName) {
    return "background" == widgetName;
  }
  ...
  Widget parse(Map<String, dynamic> map, BuildContext buildContext,
    ...
    BoxDecoration boxDecoration = map['image'] == null ? map['gradient'] == null ? BoxDecoration() : parseBoxDecoration(map) : parseBoxDecoration(map);
